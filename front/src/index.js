...
const songs = [
  ...
  new Song('../mp3/Spice-7-WhoDoYouThinkYouAre.mp3', 'Who Do You', 'Spice', 6),
  new Song('../mp3/Spice-8-SomethingKindaFunny.mp3', 'Something Kinda', 'Spice', 7),
  ...
  new Song('../mp3/SpiceWorld-5-NeverGiveUpOnTheGoodTimes.mp3', 'Never Give Up', 'Spice World', 14),
  ...
  new Song('../mp3/Forever-3-LetLoveLeadTheWay.mp3', 'Let Love Lead', 'Forever', 22),
  ...
  new Song('../mp3/Forever-9-IfYouWannaHaveSomeFun.mp3', 'If You Wanna', 'Forever', 28),
